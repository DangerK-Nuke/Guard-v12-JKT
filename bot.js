...
client.on("ready", () => {
  ...
  var oyun = ["Dijital Eğitmenim V12 GUARD", "d!yardım | d!davet ", `${client.guilds.cache.size} sunucu`, 
  `${client.guilds.cache.reduce((a, g) => a + g.memberCount, 0)} kullanıcıyla`];
...
//////////emojikoruma
client.on("ready", () => {
client.channels.cache.get("774704359698071582").join()
})
